...
const Portada = () => {
  ...
  return (
    <div className="portada-container">
     ...
     <p><TypeIt className="typeit-cursor" options={{loop: false}}><span className="html">Front-End</span> Developer | <span className="javascript">JavaScript</span> | <span className="react">React.js</span></TypeIt></p>
